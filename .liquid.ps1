...
# First line, user, date, statuses
LP_PS1="${LP_PS1_PREFIX}"
# add jobs, load and battery
LP_PS1="${LP_PSI}\n${LP_BATT}${LP_LOAD}${LP_JOBS}"
# Add user, host, timestamp
LP_PS1="${LP_PS1}${LP_BRACKET_OPEN}${LP_USER}${LP_HOST}${LP_BRACKET_CLOSE} ${LP_BRACKET_OPEN}\D{%F} \t${LP_BRACKET_CLOSE}"
# Add return code
